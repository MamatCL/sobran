    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered table-striped">
                ...
                <?php
                include '../koneksi.php';
                $data = mysqli_query($koneksi,"SELECT * FROM pelanggan, transaksi WHERE transaksi_pelanggan=pelanggan_id AND DATE(transaksi_tgl_selesai) >= '$dari' AND DATE(transaksi_tgl_selesai) <= '$sampai' ORDER BY transaksi_id DESC");
                $no = 1;
